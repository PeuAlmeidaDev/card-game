...
import { golpeCerteiro, impacto, explosao } from './passivas';
...
export const CLASSES: readonly ClasseCarta[] = [
  ...
  { id: 'mago-de-fogo', nome: 'Mago de Fogo', texto: 'Explosão: o primeiro golpe sai com o poder do feitiço, não o do braço.', modificadores: { forca: 3, vida: -3 }, passivaCombate: explosao },
];
