...
| 8 | **Item trocado vai para a mochila se couber, senão para o cemitério** | Upgrade não destrói valor — a espada velha vira moeda futura. E dá à mochila cheia consequência real: com 5 guardados, trocar de arma passa a **queimar** a antiga. A pressão aparece sozinha, sem inventar regra |
