...
| 22 | 🎲 **QUAL STAT ESQUIVA — habilidade ou agilidade? E o Impacto do Guerreiro ainda vale a pena?** A decisão **#105** escolheu **habilidade**, e o Pedro reabriu a pergunta na mesma sessão ao ver o efeito composto (*"vamos pensar em uma nova mecânica de batalha para deixar justo"*). 🔑 **A escolha é estrutural, não de dial:** com a habilidade fazendo acerto **e** esquiva, os dois efeitos **se multiplicam** e a habilidade vira o stat dominante — é isso que força o produto `vida × dano` a ser 3× (pergunta 21). Com a **agilidade** esquivando, os quatro stats ficam com um trabalho cada (habilidade = acertar · agilidade = esquivar · força = dano · vida = durar), o composto **some**, e o desenho da pergunta 21 vira uma escolha de dial em vez de uma restrição aritmética. ⚠️ **E o spec original PREVIU exatamente isso:** a Decisão 9 escreve *"candidato a refinamento futuro: dar papel à Agilidade"*. Hoje a agilidade só decide **iniciativa** — é o stat mais magro do jogo. 💰 **O custo da agilidade:** ela deixa de ser "só iniciativa" e passa a valer muito, o que mexe em todo item que dá agilidade (a Cota de Malha e a Placa do Clã dão **−1**) e no `montarCombatente` (o `PISO = 1`). ⬜ **E o Impacto (#92) fica pendurado nas duas saídas:** com a habilidade, ele morde na proporção da habilidade do defensor; com a agilidade, o empate perde qualquer relação com a condição de esquiva e vira coincidência pura. **O Pedro adiou:** *"pensamos melhor se a passiva do guerreiro ainda vale a pena"*. **O que fecharia:** `grill-me`, junto com a pergunta 21 — as duas são a mesma conversa | §5, §7 |
