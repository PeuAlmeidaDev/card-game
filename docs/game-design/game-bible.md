...
- Perder combate / cartas ruins → **Bad Stuff** (efeito da carta). ✅ **CONFIRMADO POR MONSTRO em
  ...
  - ✅ **E ele é INCONDICIONAL** (decisão **#118**, 2026-08-09): *"você sempre toma a badStuff a não
    ser que ele tenha alguma carta que diga o contrário"*. 🔑 **A escapatória é CONTEÚDO, não
    ausência** — vem de uma carta que o jogador **joga**, no eixo dos consumíveis (**2b** / #40), e
    **nunca** de um monstro que não pune. ⬜ **Essa carta não existe** e é fatia futura.
