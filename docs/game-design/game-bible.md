...
| 2 | ⏭️ **Maldições / Bad Stuff** — **A PRÓXIMA**, e 🧩 **DECOMPOSTA EM QUATRO FATIAS em 2026-08-08 (decisão #110)** | **2a** Bad Stuff + evacuação → **2b** consumíveis (`instantâneo`) → **2c** maldição no `vasculhar` → **2d** maldição na mão (mira + concorrência) | É a **1ª carta que mira outro jogador** e o **conserto da economia** — sem ela o baralho de Itens seca em 20/20 partidas (#46). ⚠️ **Adiado por três fatias** pela #61 — a `afinidade` **alivia** o mesmo sintoma (50% mais carta de Item), mas alívio não é conserto, e as três fatias acabaram. 🔴 **Como estava escrito aqui, o bloco era SEIS eixos independentes**, e os dois caminhos de volta de carta (evacuação e consumíveis) entrariam juntos — nenhum número diria qual consertou a economia (#110). ⚠️ **O 2d está BLOQUEADO pela pergunta 16 do §18**, que segue aberta |
