...
| — | ⏭️ **`empunhadura dupla`** — **A PRÓXIMA** (spec `2026-08-08-empunhadura-dupla-design.md`, plano `2026-08-08-empunhadura-dupla.md`) | a arma de uma mão passa a caber em **qualquer** mão, e o jogador escolhe qual liberar **na própria ação** (sem 4ª pendência). Fecha a queixa da **#39** sobre as mãos: a família passa de 3+1 para **4 itens numa vaga dupla**. 🎚️ **O Montante fica DOMINADO e o dial NÃO gira nesta fatia** — uma variável por vez (#24/#25/#51/#69) | ✅ |
