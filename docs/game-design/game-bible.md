...
- **5 slots de equipamento:** **Capacete · Armadura · Mão direita · Mão esquerda · Pés**.
  ...
  - ⚠️ ✅ **Trocar de raça derruba o item que ficou proibido** (#58 → **#73**) — para a mochila se
    ...
    que **segue de pé** e é a fatia `escolha do descarte` (§17).
...
| — | **`escolha do descarte`** (decisão #59) — 👉 **É A PRÓXIMA** | com a mochila cheia o jogo **pergunta** o que queimar, em **todo** desequipamento. Revoga a decisão #8 do spec da fatia 8. Traz a **3ª pendência** do jogo — estado novo, verbo novo, e o bot obrigado a saber respondê-la | ✅ |
