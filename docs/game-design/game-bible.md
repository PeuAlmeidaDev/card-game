...
- **"Morte" = evacuação:** perde **todas as cartas** (mão, equipamentos, mochila) e **mantém a
  ...
  - 🔴 **A parte "MANTÉM A PATENTE" ESTÁ REVOGADA POR DECISÃO E NÃO POR CONSTRUÇÃO** (decisão
    **#111**, 2026-08-08): o Pedro decidiu que a morte **RESETA A PATENTE**, e que o jogador
    recomeça **no próprio turno seguinte**, comprando **4 Portas + 4 Tesouros**. ⚠️ **A linha NÃO
    foi reescrita de propósito** — nada disso existe em código (perder só faz `derrotas + 1`,
    `mesa.ts:1312`), e o texto acima descreve o desenho anterior. 🔴 **E a justificativa logo
    abaixo — o parágrafo *"Por que mantém a patente"* — foi escrita como CORREÇÃO de uma versão
    que mandava para o nível 1, ou seja, o desenho novo é o desenho VELHO voltando.** A objeção
    dele está registrada na **#111** e **não foi respondida**.
...
— 🔴 **e este parágrafo inteiro é a OBJEÇÃO PENDENTE à decisão #111, que reverte para o nível 1.
Ele não foi apagado nem enfraquecido: ou ele derruba a #111, ou a #111 precisa responder a ele:**
