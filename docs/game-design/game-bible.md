...
- Perder combate / cartas ruins → **Bad Stuff** (efeito da carta). ✅ **CONFIRMADO POR MONSTRO em
  ...
  - 🎚️ **O vocabulário de hoje são dois verbos** (#114): `evacuacao` e `perdeSlot(família)`, e **só
    o monstro de 3 tesouros — o Ogro — evacua**, 1 de 5.
...
(`packages/partida/src/mesa.ts:1312` — ✏️ *citado como `:939` até 2026-08-09; a linha andou e
ninguém releu. **Cite a âncora, não a linha**: é o `derrotas: anterior.derrotas + 1` dentro de
`fecharCombate`*). E isso não é uma lacuna de conteúdo: **a evacuação é o maior
