...
| — | ✅ **`classe como carta`** (decisão #60) — **CONSTRUÍDA em dois planos: A em 2026-08-06 (#87) e B em 2026-08-08 (#88–#97)** | a classe entra pelo baralho (17/jogador, 68 na mesa), o **Aprendiz** é a ausência com `+1` de mochila, as três classes ganham **passiva de combate**, e morreram `classeId`, o `escolhasSchema`, a rota `/duelo` e o construtor no `web`. ✏️ **CORREÇÃO MARCADA (2026-08-08): o gate ocular FOI RODADO e APROVADO pelo Pedro** — os 7 itens do roteiro, com o reporte *"está certinho"*. Esta célula dizia *"PENDENTE"* porque foi escrita no commit que precede o gate. 🔑 **E o gate achou um bug que 661 testes e três revisões amplas não acharam** (*"consigo usar um machado de orc e um escudo, mas não consigo usar dois machados"*), o que virou a fatia `empunhadura dupla` abaixo | ✅ |
| — | ✅ **`empunhadura dupla`** — **CONSTRUÍDA em 2026-08-08** (spec `2026-08-08-empunhadura-dupla-design.md`; decisões **#98–#104**) | as duas mãos viram **vagas equivalentes**: todo item de uma mão declara `'mao'`, o jogador **escolhe a mão na própria ação** quando as duas estão ocupadas, e a queixa da **#39** sobre as mãos morre **sem girar dial**. **Nenhuma carta entrou ou saiu** — só a declaração de `slot` de quatro itens. 🔴 **Nasceu do gate ocular do Pedro**, não de um roteiro planejado, e deixa **um dial aberto**: o Montante ficou dominado (pergunta **20** do §18). 🔴 **Gate ocular PENDENTE** — roteiro de **5** itens no `CLAUDE.md`, nenhum conferido ainda | ✅ |
